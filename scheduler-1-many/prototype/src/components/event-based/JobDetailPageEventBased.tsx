...
import { JobDetailHeaderEventBased } from './JobDetailHeaderEventBased'
import { TasksTableEventBased, type Task } from './TasksTableEventBased'
import { TasksFlowViewEventBased } from './TasksFlowViewEventBased'
import { AddTaskDrawerEventBased, TYPE_OPTIONS, type NewTask, type EditingTask } from './AddTaskDrawerEventBased'
import type { JobConfig } from './CreateJobDrawerEventBased'
...
export function JobDetailPageEventBased({
  config,
  initialTasks,
  onBack,
  onEditJob,
    ...
    <>
      ...
      <div className="flex-1 min-h-0 flex flex-col px-8 py-6 gap-4">
        ...
        {view === 'table' ? (
          ...
          <TasksFlowViewEventBased tasks={tasks} onAddTask={() => setIsAddTaskOpen(true)} />
        )}
      </div>

      <AddTaskDrawerEventBased
