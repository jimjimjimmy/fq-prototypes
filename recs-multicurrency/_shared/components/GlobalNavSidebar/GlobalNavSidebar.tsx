...
export function GlobalNavSidebar({ activeApp, avatarFallback = 'U' }: GlobalNavSidebarProps) {
  return (
    <div className="w-[56px] bg-[#f8fafc] border-r border-solid border-[#e1e6ef] flex flex-col items-center pb-[24px] shrink-0 h-full shadow-[10px_0px_13px_-7px_rgba(0,0,0,0.04)]">
      ...
      {/* Product apps */}
      <div className="flex flex-1 flex-col items-center min-h-px min-w-px relative w-full overflow-hidden">
