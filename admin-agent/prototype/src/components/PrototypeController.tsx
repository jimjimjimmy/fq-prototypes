 ...
 * versions at runtime. Draggable by the grip handle so it can be moved out of
 * the way of any screen area; its position is persisted to localStorage.
...
const POS_KEY = 'admin-agent:prototype-controller-pos'
