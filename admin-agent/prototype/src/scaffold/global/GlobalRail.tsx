 ...
 *
 * Tokens used (from Figma variables on the L1 frame):
 *   #f8fafc — rail background (Colors/Neutral/color-neutral-100)
 *   #e1e6ef — border + divider (Borders/divider-border)
 *   #e0f6ce — product-app active background (anchor token)
 *   #186749 — product-app active border (Colors/Brand/color-brand-800)
 *   #f1f3f9 — Settings active background (Backgrounds/Light/background-200)
 *   #adb2bb — Settings active border (Borders/disabled-border, intentional)
 */
...
export function GlobalRail({
  ...
  return (
    <div className="w-14 h-full overflow-hidden bg-[#f8fafc] border-r border-[#e1e6ef] shadow-[10px_0px_13px_-7px_rgba(0,0,0,0.04)] flex flex-col items-center pb-6 shrink-0">
      ...
      <div className="flex flex-col items-center w-full shrink-0">
        {activeBottomNav === 'workspace' ? (
          <button
            ...
            className="flex items-center justify-center w-full h-[45px] shrink-0 bg-[#f1f3f9] border-l-[3px] border-[#adb2bb]"
          >
            <WorkspaceIcon />
          </button>
        ) : (
