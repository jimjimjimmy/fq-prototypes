          ...
          return (
            <div key={tab} className="flex items-center h-full px-3 shrink-0">
              <button
                ...
                className={`flex items-center justify-center gap-1 h-full py-2 text-[12px] leading-[18px] tracking-[-0.12px] whitespace-nowrap transition-colors border-b-2 ${
                  isActive
              ...
              >
                {tab === 'Admin Agent' && <AutoAwesome size={14} color="#9E70FA" />}
                {tab}
              </button>
            </div>
          );
