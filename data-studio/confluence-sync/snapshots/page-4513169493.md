...
| **Design Reference** | Figma — Connections_ParsingName ([https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName)](https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName)) |
...
> **Action needed:** The following terms introduced by this PRD should be added to the Definitions page before this PRD is finalized:
>
...
### Adding a File Definition (Path A — AI Detection)
...
_AC2 — Providing a sample filename:_
...
_AC3 — AI detects the pattern on input:_
...
_AC4 — User confirms the pattern:_
...
_AC1 — Auto-trigger on multiple dates:_
...
_AC2 — User highlights the accounting period:_
...
_AC3 — Transmission date marked as Ignore:_
...
_AC4 — Pattern saved from guided highlight:_
...
_AC1 — Adjust option available on Step 2:_
...
_AC2 — Entering guided highlight from Adjust:_
...
_AC1 — Non-date token types available in guided highlight:_
...
_AC1 — Test input available after pattern confirmation:_
...
_AC1 — Advanced mode accessible but not prominent:_
...
_AC2 — Regex editable in advanced mode:_
...
_AC3 — Advanced mode usage is logged:_
...
_AC1 — File definitions listed on connector detail:_
...
_AC1 — Edit available on each definition:_
...
_AC2 — Pattern update takes effect on save:_
...
_AC1 — Delete requires confirmation:_
...
_AC1 — Unmatched file is not silently dropped:_
...
_AC2 — Unmatched filename is visible:_
...
* Figma — Connections_ParsingName: [https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName](https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName)
...
This PRD defines how a file is recognized by its filename pattern. It does not address how the system knows what data type each column contains, or whether the file has a header row. This is required for Data Studio to correctly ingest and interpret file contents, and will need its own design exploration and requirements. Tracked as a future to-do: "File Schema / Column Mapping."
...
* **Figma — Connections_ParsingName:** [https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName](https://www.figma.com/design/Xc1ppal31OxzdiEECQl7BQ/Connections_ParsingName)
* **Data Studio Definitions & Terms:** [https://floqast.atlassian.net/wiki/spaces/Data/pages/4464869099](https://floqast.atlassian.net/wiki/spaces/Data/pages/4464869099)
* **Related PRD — Logging & Audit:** Confluence page ID 4508254281
* **Related PRD — Eventing:** IDEA-2488
* **Related PRD — Scheduling:** Confluence page ID 4504485941
* **Epic:** IDEA-2487 — Data Studio: Multi-File Handling & Global Dimensions
