...
| **Related sub-PRDs** | Entity Mapping v2 · Logging & Audit · Notifications · Entity Configuration |
...
* Entity Mapping v2 — config-time entity work

* `q3/dimensions/brainstorm.md` — dimensions auto-insert / NULL-prevention decision

* Logging & Audit — passive run-summary surface this complements

* Notifications — trigger coordination
