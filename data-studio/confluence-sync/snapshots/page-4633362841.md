...
| **QA** | *(assign)* |
| **Depends on** | Data Explorer Q3 must be shipped. Column-level metadata infrastructure must be confirmed (see OQ-A). |
...
| **Q3 predecessor** | [Data Explorer — Q3 2026 Scoped Release](https://floqast.atlassian.net/wiki/spaces/Data/pages/4633067751) |
...
* Q3 predecessor: [Data Explorer — Q3 2026](https://floqast.atlassian.net/wiki/spaces/Data/pages/4633067751)

* Confluence (Q3): [https://floqast.atlassian.net/wiki/spaces/Data/pages/4619927662](https://floqast.atlassian.net/wiki/spaces/Data/pages/4619927662) 